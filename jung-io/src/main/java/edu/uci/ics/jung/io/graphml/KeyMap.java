 ...
 * indexed by the type of GraphML metadata (node, edge, etc) that the key applies to. The <code>
 * applyKeys</code> method will obtain the list of keys that apply to the given metadata type and
...
public class KeyMap {
    ...
    private final Map<Metadata.MetadataType, List<Key>> map =
            new HashMap<Metadata.MetadataType, List<Key>>();
