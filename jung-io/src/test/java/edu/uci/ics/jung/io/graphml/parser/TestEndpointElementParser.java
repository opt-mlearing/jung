...
public class TestEndpointElementParser extends AbstractParserTest {
    ...
    public void testId() throws Exception {
        ...
        String xml = "<endpoint node=\"1\" id=\"ep1\"/>";
    ...
    public void testDesc() throws Exception {
        ...
        String xml = "<endpoint node=\"1\" id=\"ep1\">" + "<desc>hello world</desc>" + "</endpoint>";
    ...
    public void testPort() throws Exception {
        ...
        String xml = "<endpoint node=\"1\" port=\"abc123\" id=\"ep1\">" + "</endpoint>";
    ...
    public void testTypeIn() throws Exception {
        ...
        String xml = "<endpoint node=\"1\" type=\"in\">" + "</endpoint>";
    ...
    public void testTypeOut() throws Exception {
        ...
        String xml = "<endpoint node=\"1\" type=\"out\">" + "</endpoint>";
    ...
    public void testTypeUndir() throws Exception {
        ...
        String xml = "<endpoint node=\"1\" type=\"undir\">" + "</endpoint>";
    ...
    public void testTypeInvalid() throws Exception {
        ...
        String xml = "<endpoint node=\"1\" type=\"blaa\">" + "</endpoint>";
