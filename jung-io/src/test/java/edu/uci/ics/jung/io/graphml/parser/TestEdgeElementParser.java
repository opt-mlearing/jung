...
public class TestEdgeElementParser extends AbstractParserTest {
    ...
    public void testId() throws Exception {
        ...
        String xml = "<edge source=\"1\" target=\"2\" id=\"e1\"/>";
    ...
    public void testDirectedTrue() throws Exception {
        ...
        String xml = "<edge source=\"1\" target=\"2\" directed=\"true\"/>";
    ...
    public void testDirectedFalse() throws Exception {
        ...
        String xml = "<edge source=\"1\" target=\"2\" directed=\"false\"/>";
    ...
    public void testSourceTargetPorts() throws Exception {
        ...
        String xml = "<edge source=\"1\" target=\"2\" sourceport=\"a\" targetport=\"b\"/>";
    ...
    public void testDesc() throws Exception {
        ...
        String xml = "<edge source=\"1\" target=\"2\">" + "<desc>hello world</desc>" + "</edge>";
    ...
    public void testUserAttributes() throws Exception {
        ...
        String xml = "<edge source=\"1\" target=\"2\" bob=\"abc123\">" + "</edge>";
