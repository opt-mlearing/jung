...
public class WeightedChoice<T> {
     ...
     * and threshold value.
     *
     * <p>The mapping defines the weight for each item to be selected; this will be proportional to
     * the probability of its selection.
     *
     * <p>The random number generator specifies the mechanism which will be used to provide uniform
     * integer and double values.
     *
     * <p>The threshold indicates default minimum value that is treated as a valid probability (as
